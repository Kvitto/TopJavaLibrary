...
> - Обновил версию `datetimepicker` в которой работает ограничение выбора времени `startTime/endTime`
> - В профиль добавил кнопку Cancel, поправил ресурсы

#### Apply 11_0_2_fix.patch
> - Для `mail` сделал `trim()` и перенес `toLowerCase()` в `UserTo`
> - В Spring 5 добавились [Null-safety аннотации](https://stackoverflow.com/a/47885525/548473). В `ValidationUtil.getErrorResponse` IDEA предупреждает о возможном NPE.
> - Мелкие правки

#### Apply 11_0_3_fix.patch
> Добавил в REST возможность регистрации пользователя.
...
#### Apply 11_06_i18n.patch
 - Вынес общие части опций таблиц в `topjava.common.js` используя <a href="https://api.jquery.com/jquery.extend/#jQuery-extend-deep-target-object1-objectN">jQuery.extend()</a>
